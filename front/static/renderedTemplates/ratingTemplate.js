...
;var locals_for_with = (locals || {});(function (position) {var pug_indent = [];
...
pug_html = pug_html + "\n    \u003C\u002Fol\u003E\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fdiv\u003E";}.call(this,"position" in locals_for_with?locals_for_with.position:typeof position!=="undefined"?position:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}