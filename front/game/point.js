function PointJS(hc, da, ea, xa, vc) {
	...
	var Sb = function () {
		...
		, Ub = function () {
			n.runEvent("postLoop"); - 1 != ab && ($a = K - ab);
			ab = K
		}
		, G = {
			func: function () {
	...
	var wb = function (a, b, c, d) {
		...
		, $b = function (a, b, c) {
			if (q(p[a])) {
				...
				else !b.w && b.h ? (e = b.h / p[a].h, k = b.h, d = p[a].w * e) : b.w && b.h ? (d = b.w, k = b.h) : (d = p[a].w, k = p[a].h);
				c && (d *= c, k *= c);
				b.w = d;
				b.h = k;
		...
		if (a.file)
			if (q(p[a.file])) {
				if (p[a.file].loaded) {
					...
					else !a.w && a.h ? (f = a.h / p[a.file].h, e = a.h, d = p[a.file].w * f) : a.w && a.h ? (d = a.w, e = a.h) : (d = p[a.file].w, e = p[a.file].h);
		...
		if (a.file)
			if (q(p[a.file])) {
				if (p[a.file].loaded) {
					...
					else !a.w && a.h ? (l = a.h / p[a.file].h, e = a.h, d = p[a.file].w * l) : a.w && a.h ? (d = a.w, e = a.h) : (d = p[a.file].w, e = p[a.file].h);
					a.scale && (d *= a.scale, e *= a.scale);
